...
feature('Create a DateDelta', function() {
  ...
  scenario('Constructor that clones another DateDelta object', function() {
    when('calling new DateDelta(this.givenDateDelta)', function() {
      this.givenDateDelta = this.result;
      this.result = new DateDelta(this.givenDateDelta);
    });
  });

  scenario('Constructor that clones another DateDelta string', function() {
    when('calling new DateDelta(this.givenDateDelta.toString())', function() {
      this.givenDateDelta = this.result;
      this.result = new DateDelta(this.givenDateDelta.toString());
    });
  });
});
